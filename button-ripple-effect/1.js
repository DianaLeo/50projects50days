...
button.addEventListener('click', (e) => {
    ...
    divRipple.classList.add('ripple');
    ...
    //divRipple.style.left = `${rippleLeft - rippleWidth / 2}px`;divRipple.style.top = `${rippleTop - rippleWidth / 2}px`;
    divRipple.style.top = `${rippleTop}px`;
    divRipple.style.left = `${rippleLeft}px`;
    setTimeout(() => {
        divRipple.classList.remove('ripple');
